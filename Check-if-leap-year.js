// Write a program to check if a year is a leap year or not. If it is a leap year store true in the answer else store false.
...
// 3-Condition 3:If a year is divisible by 400, it is a leap year.
// Expected Input
// 2013
// Expected Output
// false
